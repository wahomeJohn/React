...
function AddEmployee(props) {
  ...
  return (
    <>
    <button onClick = {handleShow} className="block mx-auto  m-2 bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-3 rounded">
            + Add Employee</button>
      ...
      >
        ...
        <Modal.Footer>
          ...
          <button className="bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-3 rounded" 
          onClick={ handleClose}
          form= 'editform'>
            Add
            </button>
